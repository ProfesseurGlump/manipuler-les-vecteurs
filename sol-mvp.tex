...
\label{sec:org274d405}
\chapter{Solution de l'exercice 1}
\label{sec:org8bdbcac}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol1q1.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol1q2.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol1q4.png}
\end{center}
\end{enumerate}


\chapter{Solution de l'exercice 2}
\label{sec:org14891cf}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol2q1.png}
\end{center}
...
\label{sec:orga9e8caf}

\chapter{Solution de l'exercice 3}
\label{sec:orge1a3669}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol3q1.png}
\end{center}
\item On sait que
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol3q3.png}
\end{center}
\end{enumerate}


\chapter{Solution programme 2}
\label{sec:org630e97c}
...
\label{sec:org5ec5efc}

\chapter{Solution de l'exercice 4}
\label{sec:orgede8819}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol4q2.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol4q4.png}
\end{center}
\end{enumerate}


\chapter{Solution programme 3}
\label{sec:org59f3d97}
...
\label{sec:org2ee5a52}

\chapter{Solution de l'exercice 5}
\label{sec:orgc854833}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5q1.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5bisq1.png}
\end{center}
\item \begin{align*}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5bisq2.png}
\end{center}
\item \begin{align*}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5bisq3.png}
\end{center}
\item \begin{align*}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5bisq4.png}
\end{center}
\item \begin{align*}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5bisq5.png}
\end{center}
\end{enumerate}


\chapter{Solution de l'exercice 5 ter}
\label{sec:orgc7c312a}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5terq1.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol5terq2.png}
\end{center}
...
\label{sec:org3eaec60}

\chapter{Solution de l'exercice 6}
\label{sec:org1c6098c}
...
\label{sec:orgbe8a93e}

\chapter{Solution de l'exercice 7}
\label{sec:orgf812e8c}

\begin{enumerate}
\item Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol7q1.png}
\end{center}
...
\item Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol7q4.png}
\end{center}
...
\label{sec:orgb4c2f23}

\chapter{Solution de l'exercice 8}
\label{sec:org6aa3ca6}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./sol8q10.png}
\end{center}


\chapter{Solution du programme 7}
\label{sec:orgf2a35bf}
...
\label{sec:org56887f2}
\chapter{Solution de l'exercice 9}
\label{sec:org7b51234}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol9q1.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol9q2.png}
\end{center}

\item Utilisons la realtion de Chasles pour décomposer le vecteur
\(\overrightarrow{BE}\) : 
\begin{align*}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol9q3.png}
\end{center}
\end{enumerate}
...
\label{sec:org9b34900}
\chapter{Solution de l'exercice 10}
\label{sec:org373a230}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol10q2.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol10q4.png}
\end{center}
\end{enumerate}


\chapter{Solution du QCM d'auto-évaluation}
\label{sec:org6c07067}
...
\label{sec:org4802b3b}
\chapter{Solution de l'exercice 11}
\label{sec:orgf96ddd5}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol11q1.png}
\end{center}
\item Lire les coordonnées du vecteur \(\vec{v}\) sur la figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol11q2.png}
\end{center}
...
\label{sec:org7877307}
\chapter{Solution de l'exercice 12}
\label{sec:orgfc30b9b}
...
\label{sec:org7ce5dba}
\chapter{Solution de l'exercice 13}
\label{sec:org970af26}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol13q1.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol13q2.png}
\end{center}
\end{enumerate}


\chapter{Solution du QCM d'auto-évaluation}
\label{sec:orgf1cd21c}
...
\label{sec:orgc502908}
\chapter{Solution de l'exercice 14}
\label{sec:org314b6ff}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol14q1.png}
\end{center}
...
\item Calculon le déterminant \(det(\overrightarrow{OD} ,
       \overrightarrow{OB})\) :
\begin{align*}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol14q3.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol14q4.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol14q5.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol14q6.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol14q7.png}
\end{center}
\end{enumerate}

\chapter{Solution du QCM d'auto-évaluation}
\label{sec:orgc92e6c6}
...
\label{sec:orgfadfdad}
\chapter{Solution de l'exercice 15}
\label{sec:orgbe694d3}
