...
\label{sec:org83fbfa9}
\chapter{Solution de l'exercice 1}
\label{sec:org43cd608}
...
\label{sec:orga1be847}

\chapter{Solution de l'exercice 3}
\label{sec:orgc09d19e}
...
\label{sec:orgd006f90}

\chapter{Solution de l'exercice 4}
\label{sec:orgc4fb8e6}
...
\label{sec:org328cb85}

\chapter{Solution de l'exercice 5}
\label{sec:orgf4c5cc9}
...
\label{sec:orgb2fc48d}

\chapter{Solution de l'exercice 6}
\label{sec:org3de840b}
...
\label{sec:org32c1828}

\chapter{Solution de l'exercice 7}
\label{sec:org25cc735}
...
\label{sec:orgb410252}

\chapter{Solution de l'exercice 8}
\label{sec:org67723b3}
...
\label{sec:org9a02cd8}
\chapter{Solution de l'exercice 9}
\label{sec:org68de58e}
...
\label{sec:orgc2df7df}
\chapter{Solution de l'exercice 10}
\label{sec:orge5016e0}
...
\label{sec:org841a61e}
\chapter{Solution de l'exercice 11}
\label{sec:orgb27eb96}
...
\label{sec:orgc009939}
\chapter{Solution de l'exercice 12}
\label{sec:org294648a}
...
\label{sec:orgd3012de}
\chapter{Solution de l'exercice 13}
\label{sec:org6e45b46}
...
\label{sec:org1763182}
\chapter{Solution de l'exercice 14}
\label{sec:org10eefae}
...
\label{sec:org374b8b1}
\chapter{Solution de l'exercice 15}
\label{sec:org7485049}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q1.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q2.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q3.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q4.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q5.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q6.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q7.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q8.png}
\end{center}
\item L'ensemble des points \(M(x ; y)\) du plan tels que       
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q9.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q10a.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q10b.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q10c.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol17q10d.png}
\end{center}
\end{itemize}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol18.png}
\end{center}


\section{Solution de l'exercice 19}
\label{sec:org42ad6b2}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol19q2a.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol19q2b.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol19q2c.png}
\end{center}
\end{enumerate}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol20q1.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol20q2.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol20q3.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol20q4.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol20q6.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol20q7.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol22.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 23}
\label{sec:orgadb6318}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol23.png}
\end{center}


\section{Solution de l'exercice 24}
\label{sec:orgf2222af}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol24.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 26}
\label{sec:org71e0579}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./sol26.png}
\end{center}
\end{enumerate}
...
\part{Démonstrations}
\label{sec:org1044e2e}
\chapter{Démonstrations}
\label{sec:org59252f3}
\section{Solution de l'exercice 32}
\label{sec:org0425dfd}
...
\label{sec:orgfaedb0c}
\chapter{Alphabet}
\label{sec:orga97139d}

\section{Solution de l'exercice 33}
\label{sec:org50cc2c4}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol33.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 34}
\label{sec:orgcade897}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol34.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 35}
\label{sec:org84b1b26}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol35.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 36}
\label{sec:org3f1a1c0}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol36.png}
\end{center}
\end{enumerate}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol37.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 38}
\label{sec:orgf79f8e7}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol38.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 39}
\label{sec:org095fa90}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol39.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 40}
\label{sec:org55ca3d1}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol40.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 41}
\label{sec:orga7a4ba8}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol41.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 42}
\label{sec:org6a13581}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol42.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 43}
\label{sec:org4088630}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol43.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 44}
\label{sec:org8db814a}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol44.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 45}
\label{sec:org8b9428e}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol45.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 46}
\label{sec:orgd09e4b9}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol46.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 47}
\label{sec:org0c9de95}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol47.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 48}
\label{sec:org3c777c6}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol48.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 49}
\label{sec:orga844465}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol49.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 50}
\label{sec:org67d13d5}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol50.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 51}
\label{sec:org847fd94}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol51.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 52}
\label{sec:org124be0f}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol52.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 53}
\label{sec:orgc7c900b}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol53.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 54}
\label{sec:orgfa7a6ca}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol54.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 55}
\label{sec:orgffcffe9}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol55.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 56}
\label{sec:orgc89606e}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol56.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 57}
\label{sec:org06e8f9c}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol57.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 58}
\label{sec:org33e4123}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol58.png}
\end{center}
\end{enumerate}

\chapter{Applications des vecteurs dans la vie réelle}
\label{sec:org9bae7ee}

\section{Solution de l'exercice 59}
\label{sec:org700f542}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol64q3.png}
\end{center}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol64q5.png}
\end{center}
...
\chapter{Chiffres}
\label{sec:orga00d13f}
\section{Solution de l'exercice 67}
\label{sec:org926127c}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol67.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 68}
\label{sec:orge6ea8ab}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol68.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 69}
\label{sec:org4179534}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol69.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 70}
\label{sec:org8a0f755}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol70.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 71}
\label{sec:org194dde2}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol71.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 72}
\label{sec:org1c13c3f}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol72.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 73}
\label{sec:orge0e337b}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol73.png}
\end{center}
\end{enumerate}


\section{Solution de l'exercice 74}
\label{sec:org55d76e2}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol74.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 75}
\label{sec:org5cd6f1a}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol75.png}
\end{center}
\end{enumerate}

\section{Solution de l'exercice 76}
\label{sec:orgc36256a}
...
Voir figure :
\begin{center}
\includegraphics[width=.9\linewidth]{./img/sol76.png}
\end{center}
\end{enumerate}


\part{Solutions des exercices divers}
\label{sec:org7fd842c}
\chapter{Solutions des paradoxes}
\label{sec:org3981496}
\section{Solution de l'exercice 77}
\label{sec:org3a34a5e}
...
\label{sec:org44f750c}
\section{Solution de l'exercice 78}
\label{sec:org6c10c14}
