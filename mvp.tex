...
\part{Introduction}
\label{sec:orge72a0ba}
\chapter{À qui s'adresse ce livre}
\label{sec:orgf5c5d19}
...
\chapter{Contenu 1}
\label{sec:org741ffa3}

\section{Objectifs pédagogiques}
\label{sec:org7e301e0}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./C1.png}
\end{center}

\section{Exercice 1}
\label{sec:org83a5cb2}
...
\chapter{Contenu 2}
\label{sec:orgef3a09b}
\section{Objectifs pédagogiques}
\label{sec:org0fd6556}
...
\chapter{Contenu 3}
\label{sec:org595b7d4}

\section{Objectifs pédagogiques}
\label{sec:orgb933366}
...
\chapter{Contenu 4}
\label{sec:orgc00862e}

\section{Objectifs pédagogiques}
\label{sec:orga2a50eb}
...
\chapter{Contenu 5}
\label{sec:orgbe26aaa}

\section{Objectifs pédagogiques}
\label{sec:org3001be4}
...
\chapter{Contenu 6}
\label{sec:org0284c5e}

\section{Objectifs pédagogiques}
\label{sec:orgdeb586e}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./Oijorthonormaluv.png}
\end{center}
...
\chapter{Contenu 7}
\label{sec:orgdf65060}

\section{Objectifs pédagogiques}
\label{sec:org073adff}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./figexo8.png}
\end{center}
...
\label{sec:org803d499}
\section{Objectifs pédagogiques}
\label{sec:orge98623e}
...
\section{Exercice 9}
\label{sec:orgc31f625}

On considère le triangle ABC représenté sur la figure avec le
quadrillage :

\begin{center}
\includegraphics[width=.9\linewidth]{./ABCtrig.png}
\end{center}
...
\label{sec:org172e7ac}
\section{Objectifs pédagogiques}
\label{sec:orgb5edd6b}
...
\label{sec:org33ae0f8}
\section{Objectifs pédagogiques}
\label{sec:org0b0d5d2}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./figexo11.png}
\end{center}
\end{enumerate}


\section{QCM d'auto-évaluation}
\label{sec:org0c2a5c4}
...
\label{sec:orgb29f501}
\section{Objectifs pédagogiques}
\label{sec:org08e9a25}
...
\label{sec:org016fc5f}
\section{Objectifs pédagogiques}
\label{sec:org336a632}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./figexo13.png}
\end{center}
...
\label{sec:org6c34a93}
\section{Objectifs pédagogiques}
\label{sec:org0e21249}
...
\label{sec:org78b06c8}
\section{Objectifs pédagogiques}
\label{sec:org686198e}
...
\label{sec:orgcb172e8}
\chapter{Pour s'exercer davantage}
\label{sec:org8c4e168}
\section{Exercice 16}
\label{sec:org7683aa5}
...
\label{sec:orgb28ee2c}
\chapter{Représentation par coordonnées (dans un repère)}
\label{sec:orgd0a6ee1}
\section{Exercice 27}
\label{sec:orge44bc54}
...
\label{sec:org4a43368}
\section{Exercice 28}
\label{sec:org7c0b7ea}
...
\label{sec:orgaf41a01}

\section{Exercice 30}
\label{sec:orgafc8876}
...
\label{sec:org9d87e75}

\section{Exercice 59}
\label{sec:orgb8d6d63}
...
\section{Exercice 60}
\label{sec:orgf7b4cec}

On considère un échiquier standard comme celui sur la figure
ci-dessous :

\begin{center}
\includegraphics[width=.9\linewidth]{./chessboard_wiki.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./fou_motion.png}
\end{center}
...
\chapter{Chiffres}
\label{sec:orgc071a4a}
\section{Introduction}
\label{sec:orgb439667}
