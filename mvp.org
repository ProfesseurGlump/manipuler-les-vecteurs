...
*** Exercice 24
    ...
    1. Quelle est la nature du triangle OIJ ?
    2. Soit A le milieu du segment [IJ]. Exprimer le vecteur
       \(\overrightarrow{OA}\) en fonction de \(\vec{i}\) et
       \(\vec{j}\). 
    3. Soit B l'image de A par la translation de vecteur
       \(\overrightarrow{OA}\). Calculer OB. 
    4. Quelle est la nature du quadrilatère OIBJ ?
    5. Soit C le point tel que \(\overrightarrow{IC} =
       \vec{i}\). Quelle est la nature du triangle OCB ?
    6. Soit K le point tel que \(\overrightarrow{JK} = \vec{i} +
       \vec{j}\) et L le point tel que \(\overrightarrow{IL} =
       \overrightarrow{OB}\). Quelle est la nature du quadrilatère
       IJKL ?
    7. Soit D le point tel que \(\overrightarrow{ID} =
...
*** Exercice 25
    ...
    1. Placer I' image de I par la translation de vecteur
    ...
    3. Tracer le cercle \(C_1\) de centre O et de rayon 1. Puis tracer le
    ...
    4. Quelle est la nature du triangle IAI' ? On appellera B
    ...
    5. Exprimer le vecteur \(\overrightarrow{AB}\) en fonction du
       vecteur \(\overrightarrow{AI'}\). Qu'en déduire pour B par
       rapport au segment [AI'] ?
    6. Exprimer le vecteur \(\overrightarrow{AC}\) en fonction du
       vecteur \(\overrightarrow{AI}\). Qu'en déduire pour C par
       rapport au segment [AI] ?
    7. Placer C' image de C par la translation de vecteur
...
*** Exercice 26
    ...
    1. Placer le point A tel que \(\overrightarrow{IA} =
    ...
    9. Pour compléter la figure tracer \(\vec{j}, \overrightarrow{JC},
       \overrightarrow{CI}\) et vérifier que OICJ est bien un carré.
    10. Pour ajouter une touche finale tracer les vecteurs :
        \begin{align*}
...
*** Exercice 64 : Pourquoi les PDF sont-ils vectoriels ?
    ...
    *Questions :*
    ...
    3. Calculer les normes \(\|\overrightarrow{OM}\|\), 
       \(\|\overrightarrow{MN}\|\) et \(\|\overrightarrow{ON}\|\). La
       lettre "V" est-elle symétrique ?
       
    4. Le /designer/ (graphiste en bon français) applique une transformation : tous les points 
...
*** Exercice 66 : Créer une icône vectorielle (Projet)
    ...
    *Pour aller plus loin* : Les /designer/ (graphiste en bon
...
*** Exercice 67
	...
	1. Placer le point A tel que \(\overrightarrow{OA} =
           -\vec{i}\). En déduire ses coordonnées.
	2. Placer le point B tel que \(\overrightarrow{JB} =
           \vec{j}\). En déduire ses coordonnées.          
	3. Placer le point C tel que \(\overrightarrow{BC} =
           -\vec{i} - \vec{j}\). En déduire ses coordonnées.          
	4. Tracer les vecteurs \(\overrightarrow{OA}, \vec{i},
...
*** Exercice 68
	...
	1. Placer le point A tel que \(\overrightarrow{JA} =
           \vec{i}\). En déduire ses coordonnées.
	2. Placer le point B tel que \(\overrightarrow{AB} =
           \vec{j}\). En déduire ses coordonnées.          
	3. Placer le point C tel que \(\overrightarrow{BC} =
           -\vec{i}\). En déduire ses coordonnées.          
	4. Tracer les vecteurs \(\vec{i}, \vec{j},
...
*** Exercice 69
	...
	3. Placer le point C tel que \(\overrightarrow{BC} =
           -\vec{i}\). En déduire ses coordonnées.          
	4. Tracer les vecteurs \(\vec{i}, \overrightarrow{IA},
...
*** Exercice 70
	...
	2. Placer le point B tel que \(\overrightarrow{AB} =
           \vec{j}\). En déduire ses coordonnées.          
	3. Placer le point C tel que \(\overrightarrow{JC} =
           \vec{j}\). En déduire ses coordonnées.          
	4. Tracer les vecteurs \(\overrightarrow{IA},
...
*** Exercice 72
	...
	3. Placer le point C tel que \(\overrightarrow{BC} =
           \vec{i}\). En déduire ses coordonnées.          
	4. Tracer les vecteurs \(\vec{i}, \vec{j}, \overrightarrow{IA},
           \overrightarrow{AJ}, \overrightarrow{JB}, \overrightarrow{BC}\).
...
*** Exercice 81
    ...
    1. Placer le point A tel que \(\overrightarrow{OA} = \vec{u} =
    ...
    2. En géométrie classique l'angle AOB peut se lire dans les deux
